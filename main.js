...
const bofuloTexture = new THREE.TextureLoader().load('bofulo.jpg')

const bofulo = new THREE.Mesh(
  new THREE.BoxGeometry(3, 3, 3),
  new THREE.MeshBasicMaterial({map: bofuloTexture})
)
...
function moveCamera(){
  ...
  bofulo.rotation.y += 0.01;
  bofulo.rotation.z += 0.01;
